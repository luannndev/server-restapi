...
public class UUIDUtility {
    ...
    public @Nullable UUID getUniqueId(String userName) {
    ...
    private String[] getRemoteUserData(String nameOrUuid) {
        try {
    ...
    private @Nullable UUID validateUniqueId(String string) {
        if (string.length() != 32) {
            return null;
        }
        if (string.contains("-")) {
